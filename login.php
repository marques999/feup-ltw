...
<div class="column-group half-vertical-space">
	...
	<form action="action_login.php" method="POST" class="ink-form ink-formvalidator">
		<fieldset>
			...
			<div class="control-group column-group half-gutters">
				<div class="control all-100">
					<p class="align-center">Don't have an account? <a href="register.php">Sign up here</a></p>
				</div>
			</div>
		</fieldset>
	</form>
...
<?} else {?>
	<form action="action_logout.php" method="POST" class="ink-form all-33 large-60 medium-80 small-100 tiny-100">
		<fieldset>
			<legend class="align-center">Log out</legend>
			<div class="control-group column-group half-gutters">
