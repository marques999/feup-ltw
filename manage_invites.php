    ...
    $(document).ready(function() {
		...
		$('button.accept').each(function() {
        	$(this).click(function(evt) {		
        		var postArgs = {'idEvent': $(this).attr('event'), 'idUser': <?=$thisUser?>};
				$.post('actions/action_invite_accept.php', postArgs, function(response) {
		         	location.reload(); 
	     		});
     		})
     	});
		...
		$('button.reject').each(function() {		
			$(this).click(function(evt) {		
				var postArgs = {'idEvent': $(this).attr('event'), 'idUser': <?=$thisUser?>};
				$.post('actions/action_invite_reject.php', postArgs, function(response) {
		        	location.reload(); 
				});
			});
		});
