...
<div class="all-100">
    ...
    <div class="column-group panel half-vertical-space">
        ...
        <p class="vertical-space"><?=$thisThread['message']?></p>
            ...
            <small><button class="ink-button red"><i class="fa fa-pencil"></i> Reply</button></small>
            <small><button class="ink-button red"><i class="fa fa-quote-right"></i> Quote</button></small>
            <?if($threadOP==$thisUser){?>
            <small><button class="ink-button red"><i class="fa fa-remove"></i> Delete</button></small>
            <?}?>
        </p>
    </div>
    </div>
    ...
    <?if($numberPosts>0) {                  
        ...
        <div class="column-group panel half-vertical-space">
            ...
            <p class="vertical-space"><?=$currentPost['message']?></p>
                <p class="no-margin align-right">
                <small><a href="#write-comment" class="ink-button red"><i class="fa fa-pencil"></i> Reply</a></small>
                <?if($currentPost['idUser']==$thisUser){?>
                <small><a class="ink-button red"><i class="fa fa-remove"></i> Delete</a></small>
                <?}else{?>
                <small><a class="ink-button red"><i class="fa fa-quote-right"></i> Quote</a></small>
                <?}?>
            </p>
            </div>
        </div>
